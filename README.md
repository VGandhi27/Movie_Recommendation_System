...
![Frontend](https://img.shields.io/badge/Frontend-Pycharm-green)
![API](https://img.shields.io/badge/API-TMDB-fcba03)

A content-based recommender system that recommends movies similar to the movie the user likes and analyses the sentiments of the reviews given by the user.

Check out the live demo: soon to be deployed

Link to youtube demo: soon to be deployed
...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/VGandhi27/movie_recommendation_system/blob/master/movies_recommender_system/venv/requirements.txt) file with the command `pip install -r requirements.txt`
...
2. [The Movies Dataset](https://www.kaggle.com/datasets/tmdb/tmdb-movie-metadata?select=tmdb_5000_movies.csv)
